<template>
  <div>
    ...
    <form @submit.prevent="submitForm" class="bg-tokyo-night-dark border border-tokyo-night-gray/30 p-6 rounded flex flex-col gap-4 w-full">
...
const { form, loading, error, submitForm, resetForm } = useContactForm();
</script>